...
import {castTimeFormat, getRuntimeHours, getCommaSeparatedLine} from './../../../utils.js';
import {createFilmCommentsTemplate} from './../../main/films/comments.js';
...
const createFilmDetailsTemplate = (card) => {
  ...
  return `<section class="film-details">
            <form class="film-details__inner" action="" method="get">
              ...
              ${createFilmCommentsTemplate(card.comments)}`;
};
